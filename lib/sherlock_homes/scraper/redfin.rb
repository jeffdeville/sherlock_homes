module SherlockHomes
  class Scraper::Redfin < Scraper
    ...
    class SummaryInfo < SitePrism::Section
      element :description, 'span[data-reactid=".0.1.0.2.1.0.2.0.1"]'
      element :style, 'td[data-reactid=".0.1.0.2.1.0.3.0.0.1.1"]'
      element :view, 'td[data-reactid=".0.1.0.2.1.0.3.0.0.2.1"]'
      element :county, 'td[data-reactid=".0.1.0.2.1.0.3.0.0.3.1"]'
      element :property_type, 'td[data-reactid=".0.1.0.2.1.0.3.1.0.0.1"]'
      element :community, 'td[data-reactid=".0.1.0.2.1.0.3.1.0.2.1"]'
      element :mls, 'td[data-reactid=".0.1.0.2.1.0.3.1.0.3.1"]'
    end
    ...
    section :summary_info, SummaryInfo, 'div[data-reactid=".0.1.0.2.1"]'
